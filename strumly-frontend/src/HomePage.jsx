...
export default function HomePage({user,onLogout}){
  ...
  if(view.type==="followRequests")return(<><style>{CSS}</style><div className="min-h-screen bg-zinc-950"><button onClick={()=>setView({type:"home"})} className="fixed top-4 left-4 text-zinc-400 hover:text-white z-10 bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2 text-sm">← Back</button><FollowRequestsPage/></div></>);
